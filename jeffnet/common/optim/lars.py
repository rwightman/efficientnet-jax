""" Optax LARS Optimizer

Taken from https://github.com/deepmind/deepmind-research/blob/master/byol/utils/optimizers.py
Apache 2.0 License, copyright below
...
from .helpers import FilterFn, ScalarOrSchedule, scale_by_learning_rate, exclude_bias_and_norm
...
def lars(
    ...
    if weight_decay_filter is None:
        # FIXME always pass in exclusions or assume defaults?
    ...
    return optax.chain(
        add_weight_decay(weight_decay=weight_decay, filter_fn=weight_decay_filter),
        scale_by_lars(momentum=momentum, eta=eta, filter_fn=lars_adaptation_filter),
